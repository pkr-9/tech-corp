...
//     title: "High-Performance Banking Engine",
//     client: "FinTech Startup (Stealth)",
//     category: "FinTech",
//     date: "Development Phase",
//     heroImage: "/casestudy/case-fintech.jpg",
//     challenge:
//       "Modern neo-banks require microsecond latency and absolute consistency. The challenge is building a ledger system that can handle high-frequency transactions without the bloat of legacy banking cores.",
//     solution:
//       "We architected a solution using a microservices pattern on AWS. By utilizing Kafka for event streaming and a double-entry ledger system on PostgreSQL, we ensure data integrity while maintaining scalability.",
//     results: [
//       "Designed to handle 10k+ TPS",
