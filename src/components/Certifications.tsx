          ...
          {certifications.map((cert, index) => {
            ...
            return (
              <div
                key={cert.title}
                className={cn(
                  "group relative p-6 rounded-2xl bg-card border border-border hover:border-primary/50 transition-all duration-700 hover:shadow-3d hover:-translate-y-1 cursor-default flex items-start gap-5 transform",
                  isVisible
