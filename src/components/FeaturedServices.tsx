import { Monitor, Smartphone, Cloud, BrainCircuit, ArrowRight } from "lucide-react";
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            From initial concept to final deployment, we have the expertise to cover every angle of your product's development.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 mb-6">
                  <div className={`inline-flex p-4 rounded-2xl bg-gradient-to-br ${service.gradient} shadow-lg group-hover:shadow-glow transition-all duration-500 group-hover:scale-110 group-hover:rotate-3`}>
